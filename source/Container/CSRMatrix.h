...
template <typename T>
void Transpose(const CSRMatrix<T> &A, CSRMatrix<T> &At) noexcept
{
...
template <typename T>
void TransposeStructure(const CSRMatrix<T> &A, CSRMatrix<T> &At) noexcept
{
	Assert(A.rows == At.columns);
	Assert(A.columns == At.rows);
...
template <typename T>
void Transpose(const CSRMatrix<T> &A, CSCMatrix<T> &At) noexcept
{
	Assert(A.rows == At.columns);
	Assert(A.columns == At.rows);
...
template <typename T>
void TransposeStructure(const CSRMatrix<T> &A, CSCMatrix<T> &At) noexcept
{
	Assert(A.rows == At.columns);
	Assert(A.columns == At.rows);
...
template <typename T>
void Transpose(const CSCMatrix<T> &A, CSRMatrix<T> &At) noexcept
{
	Assert(A.rows == At.columns);
	Assert(A.columns == At.rows);
...
template <typename T>
void TransposeStructure(const CSCMatrix<T> &A, CSRMatrix<T> &At) noexcept
{
	Assert(A.rows == At.columns);
	Assert(A.columns == At.rows);
...
template <typename T>
void Convert(const CSCMatrix<T> &C, CSRMatrix<T> &R) noexcept
{
...
template <typename T>
void Convert(const CSRMatrix<T> &R, CSCMatrix<T> &C) noexcept
{
